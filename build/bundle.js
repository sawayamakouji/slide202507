...
const TitleScene = ({ text, color, image }) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: animation, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StyledTitle, { color, image, children: text }) });
};
const InfoScene = ({ title, children, image }) => {
  const titleAnim = useAppearAnimation(0);
  const contentAnim = useAppearAnimation(15);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { className: image ? "bg-transparent" : "bg-gray-900", "items-center": true, "justify-center": true, "text-center": true, "p-8": true, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: titleAnim, className: "text-8xl font-bold text-white mb-12 drop-shadow-lg", children: title }),
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: index * SCENE_DURATION, durationInFrames: SCENE_DURATION, children: [
      ...
      (() => {
        switch (scene.type) {
          ...
          case "info":
            return scene.title && scene.children ? /* @__PURE__ */ (0,jsx_runtime.jsx)(InfoScene, { title: scene.title, children: scene.children, image: scene.image }) : null;
          case "code":
...
const scenario_namespaceObject = /*#__PURE__*/JSON.parse('[{"type":"info","title":"シナリオはGemini CLIで","children":"Gemini CLIに話しかけるだけで<br />動画のシナリオが描いてもらってシナリオ.mdに"},{"type":"info","title":"コミットするだけ","children":"シナリオをコミットすれば<br />GitHub Actionsが自動で動画をレンダリング"},{"type":"info","title":"ブラウザで確認！！","children":"レンダリングされた動画は<br />GitHubからダウンロードできます"},{"type":"info","title":"画像付きのシーン","children":"このシーンには画像が表示されます。","image":"/images/download.png"},{"type":"info","title":"試してみようぜい！！！！！！！","children":"あなたもGemini CLIと<br/>GitHub Actionsで<br/>動画を自動作成！"}]');
;// ./src/Root.tsx
...
const RemotionRoot = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "MyVideo",
      component: MyVideo,
      durationInFrames: scenario_namespaceObject.length * SCENE_DURATION,
      fps: 30,
      width: 1920,
      height: 1080,
      schema: myVideoSchema,
      defaultProps: {
        scenario: scenario_namespaceObject
        // パースしたシナリオをPropsとして渡す
      }
    }
  ) });
};
